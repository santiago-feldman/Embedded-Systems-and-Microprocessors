...
// UART2 TX and RX
#define UART2_TX_PIN PORTNUM2PIN(PD, 2) // guarda que se pisa
#define UART2_RX_PIN PORTNUM2PIN(PD, 3) // puto el que lee
...
// SPI0 pins
#define SPI0_MISO PORTNUM2PIN(PD, 3) // PTD3
#define SPI0_MOSI PORTNUM2PIN(PD, 2) // PTD2
#define SPI0_SCK PORTNUM2PIN(PD, 1)  // PTD1
#define SPI0_SS PORTNUM2PIN(PC, 4)  // PTC4

// I2C0 SCK and SDA   Accelerometer and Magnetometer
