...
outputs:
- {id: Bus_clock.outFreq, value: 50 MHz, locked: true, accuracy: '0.001'}
- {id: Core_clock.outFreq, value: 100 MHz}
- {id: ERCLK32K.outFreq, value: 1 kHz}
- {id: Flash_clock.outFreq, value: 25 MHz}
- {id: FlexBus_clock.outFreq, value: 50 MHz, locked: true, accuracy: '0.001'}
...
- {id: MCG.PRDIV.scale, value: '16', locked: true}
        ...
        .pll0Config =
            {
                ...
                .prdiv = 0xfU,                    /* PLL Reference divider: divided by 16 */
